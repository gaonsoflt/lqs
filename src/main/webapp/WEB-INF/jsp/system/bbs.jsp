...
// 							cre_usr 	: { type : "string", editable : false, defaultValue : "${userStore.username}" },
			...
			columns : [
				...
				{ field : "attached", title: "파일사용", width : 80, attributes: {style: "text-align: center;"} },
				{ field : "cre_dt", title : "생성일", width: 150, attributes : { style : "text-align: center;" },
					template : "#= (cre_dt == '') ? '' : kendo.toString(new Date(Number(cre_dt)), 'yyyy-MM-dd') #" 
				},
				{
					title : "",
