											...
											<tr>
												...
												<td>
													<input id="parent-name" name="parent-name" 
															data-option-label="상위메뉴를 선택하세요."
															data-role="dropdownlist"
															data-auto-bind="true"
															data-value-primitive="true"
															data-text-field="menu_name"
	            											data-value-field="menu_seq"
															data-bind="value:selected.parent_seq,
																		source: parentMenuDS,
																		enabled: isEditable"
															required validationMessage="상위메뉴를 선택하세요."
...
// 						url: "${contextPath}/sm/bbs/readNotUse.do",
            ...
            parentMenuDS: new kendo.data.DataSource({
            	transport: {
					read : { 
						url: "${contextPath}/sm/menu/getParentMenuList.do",
						dataType: "jsonp"
					},
					parameterMap: function(data, type) {
						if (type == "read"){
