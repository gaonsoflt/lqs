...
<%--   	<script src="<c:url value='/resource/style/espa/vendor/jquery/jquery-1.11.1.min.js'/>"></script> --%>
	...
	<!-- message -->
	<script src="<c:url value='/resource/js/comm/message.js'/>" type="text/javascript" ></script>
	<script src="<c:url value='/resource/js/comm/menu.js'/>" type="text/javascript" ></script>
	<script src="<c:url value='/resource/js/comm/page-auth.js'/>" type="text/javascript" ></script>
