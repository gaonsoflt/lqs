...
<title>에러 | <spring:message code="error.access" text="access denied" /></title>
</head>
				...
				<div class="admin-form theme-info mw700" style="margin-top: 3%;" id="login1">
					<div class="row mb15 table-layout">
						<div class="col-xs-6 va-m pln">
							<a href="dashboard.html" title="Return to Dashboard"> 
								<img src="<%=request.getContextPath() + Config.getConfigValue(ConfigID.LOGO)%>" title="AdminDesigns Logo" class="img-responsive w250">
							</a>
						</div>
					...
					<div class="panel panel-info mt10 br-n">
						<div class="panel-body p25 bg-light">
							...
							<spring:message code="error.msg.access" text="access denied" />
						</div>
					</div>
				</div>
			</section>
