...
<%@ page import="egovframework.system.config.ConfigID" %>
<%@ page import="egovframework.system.config.Config" %>
...
<title><%=Config.getConfigValue(ConfigID.TITLE)%></title>
</head>
					...
					<div class="row mb15 table-layout">
						<div class="col-xs-6 va-m pln">
							<a href="dashboard.html" title="Return to Dashboard"> 
								<img src="<%=request.getContextPath() + Config.getConfigValue(ConfigID.LOGO)%>" title="Logo" width="250" height="45" class="w250"/>
							</a>
						</div>
...
<!-- 									</div> -->
								...
								<div class="section mb15">
									<label class="option block mt15"> 
										...
										<a href="#" onclick="fn_open_term();" class="theme-link"> <spring:message code="signup.terms" text="default text" /></a>
	...
	<script type="text/javascript">
		...
		function fn_open_term() {
			$("#wnd-term").data("kendoWindow").center().open();
		}
