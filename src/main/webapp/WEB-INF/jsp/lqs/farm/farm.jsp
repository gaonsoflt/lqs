...
<%@ include file="../../inc/aside.jsp"%>
	...
	<section id="content" class="table-layout animated fadeIn">
		<div class="row">
			...
			<div class="col-md-12">
				<button type="button" class="btn btn-primary btn-sm btn-auth-c" onclick="location.href='${contextPath}/farm/form.do'"><spring:message code="button.add"/></button>
				<div id="grid-farm"></div>
			</div>
		</div>
	</section>
</section>
<script>
	...
	$(function() {
		...
		$("#searchBtn").kendoButton({
			icon : "search",
			click : function(e) {
				$("#grid-farm").data("kendoGrid").dataSource.read();
			}
		});
	...
	$(document).ready(function() {
		...
		$("#grid-farm").kendoGrid({
			...
			dataSource : {
				transport : {
					read : { 
						url : "${contextPath}/farm/list.do", 
						dataType : "jsonp",
						complete: function(e){ 
					    	console.log("grid-farm:dataSource:list:complete");
					    }
					},
					parameterMap : function(data, type) {//type =  read, create, update, destroy
						if (type == "read") {
				...
				schema : {
					...
					model : {
						id : "farm_seq",
						fields : {
							farm_seq 		: { type: "number", editable: false },
							biz_type 		: { type: "string", editable: false },
							biz_type_name	: { type: "string", editable: false },
							reg_number 		: { type: "string", editable: false },
							farm_name 		: { type: "string", editable: false },
							...
							run_yn			: { type: "boolean", editable: false }
						}
					}
				},
				error : function(e) {
            ...
            toolbar: false,
			columns : [
				{ field : "farm_seq", title : "등록번호", width : 150, attributes : { style : "text-align: center;" } },
				{ field : "biz_type_name", title : "사업형태", width : 150, attributes : { style : "text-align: center;" } },
				{ field : "farm_name", title : "농장명", attributes : { style : "text-align: center;" } },
				{ field : "owner", title : "농장주", width : 200, attributes : { style : "text-align: center;" } },
				...
				{ field : "run_yn", title : "운영여부", width : 100, attributes : { style : "text-align: center;" },
					template : "#= (run_yn) ? '운영' : '미운영' #"
				},
			...
			change: function(e) {
				...
				location.href="${contextPath}/farm/form.do?seq=" + selectedItem.farm_seq;
			},
			sortable : true,
